...
function Favourites() {
  return (
    <>
      ...
      <div className='m-6 flex justify-center space-x-2'>
        <input type="text" placeholder='Search...' className='border-2 text-center'/>
        <input type="number" min='1' max='20' className='border-2 text-center'/>
      </div>
      <DataTable></DataTable>
...
<div className="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
  <table className="w-full border-collapse bg-white text-left text-sm text-gray-500">
    <thead className="bg-gray-50">
      <tr>
        <th scope="col" className="px-6 py-4 font-medium text-gray-900"><div className='flex justify-center items-center'>Name</div></th>
        <th scope="col" className="px-6 py-4 font-medium text-gray-900">
          ...
          <div>Ratings</div>
          <img src="https://img.icons8.com/external-those-icons-lineal-those-icons/24/000000/external-down-arrows-those-icons-lineal-those-icons-4.png" className="ml-2 mr-2"></img>
          </div>
        </th>
        <th scope="col" className="px-6 py-4 font-medium text-gray-900">
          <div className='flex justify-center items-center'>
        ...
        <th scope="col" className="px-6 py-4 font-medium text-gray-900"><div className='flex justify-center items-center'>Remove</div></th>
      </tr>
    </thead>
    <tbody className="divide-y divide-gray-100 border-t border-gray-100">
      <tr className="hover:bg-gray-50">
        ...
        <td className="px-6 py-4 text-center">
        <span class="inline-flex items-center gap-1 rounded-full bg-gray-300 px-2 py-1 text-xs font-semibold text-red-700">
          Delete
        </span>
        </td>
      </tr>
